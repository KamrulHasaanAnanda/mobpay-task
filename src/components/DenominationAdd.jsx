...
function DenominationAdd({changeCurrency,setchangeCurrency,setCurrencyModal}) {
  ...
  return (
    ...
    <ChangeCurrencyModal open={changeCurrency} setopen={setchangeCurrency} setCurrencyModal={setCurrencyModal}/>
  </div>
  )
}
